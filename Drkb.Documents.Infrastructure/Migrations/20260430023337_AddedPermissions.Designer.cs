...
namespace Drkb.Documents.Infrastructure.Migrations
{
    ...
    [Migration("20260430023337_AddedPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drkb.Documents.Domain.Entity.CategoryPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PermissionSubjectId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Drkb.Documents.Domain.Entity.DocumentPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Drkb.Documents.Domain.Entity.UserFavoriteDocument", b =>
                {
                    b.HasOne("Drkb.Documents.Domain.Entity.Document", "Document")
                        .WithMany("UserFavoriteDocuments")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Drkb.Documents.Domain.Entity.Document", b =>
                {
                    ...
                    b.Navigation("UserFavoriteDocuments");
                });
